...
testthat::test_that("expected behavior", {
    ...
    # write sf to duckdb
    ddbs_write_vector(conn_test, argentina_sf, "envelope_tbl", overwrite = TRUE)
...
testthat::test_that("error if table already exists", {
    ...
    testthat::expect_true(tester(x = "envelope_tbl",
                                    conn = conn_test,
                                    name = 'banana',
                                    overwrite = FALSE)
                             )
    ...
    testthat::expect_error(tester(x = "envelope_tbl",
                                    conn = conn_test,
                                    name = 'banana',
                                    overwrite = FALSE))
