...
![Benchmark that compares spatial join for duckspatial and sf](../man/figures/bench/bench-st-join-faster-query.png){#fig-st-join fig-align="center"}
...
![Benchmark that compares spatial filter for duckspatial and sf](../man/figures/bench/bench-st-filter-faster-query.png){#fig-st-filter fig-align="center"}
...
![Benchmark that compares spatial distance for duckspatial and sf](../man/figures/bench/bench-st-distance-faster-query.png){#fig-st-distance fig-align="center"}
...
![Benchmark that compares dissolving geometries by group for duckspatial and sf](../man/figures/bench/bench-st-dissolve-faster-query.png){#fig-st-dissolve fig-align="center"}
...
-   Using 1 million points: {duckspatial} was about 28 times faster than {sf}, and allocated 4 times less memory.

-   Using 3 million points: {duckspatial} was about 32 times faster than {sf}, and allocated 2 times less memory.
...
![Benchmark that compares the geometry predicate ST_Intersects(x, y) for duckspatial and sf](../man/figures/bench/bench-st-intersects-faster-query.png){#fig-st-intersects fig-align="center"}
