...
orienting its components in a deterministic way. This is useful when
comparing geometries that are topologically equal but differ in vertex
order or component ordering. The geometry type and CRS are preserved.
