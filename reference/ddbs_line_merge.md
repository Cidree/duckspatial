...
Merges a collection of line geometries that share endpoints into a
single `LINESTRING`, or `MULTILINESTRING` if endpoints are not shared
...
- preserve:
  ...
  a logical value. If `TRUE` (default), line direction is preserved
